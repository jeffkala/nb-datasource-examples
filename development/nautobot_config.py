...
# This repo is a Git datasource payload (custom validators, jobs, designs, etc.),
# not an installable app — its content is loaded by adding a GitRepository in Nautobot.
PLUGINS = []
